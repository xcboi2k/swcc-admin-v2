...
const Header = () => {
  return (
    <div className="w-full relative">
      <div className="absolute w-full h-full top-0 left-0 bg-landingImage z-20"></div>
        <div className="absolute w-full h-full top-0 left-0 bg-landingImage z-10">
        ...
        <div className="flex flex-col justify-center z-40 relative px-20 py-20">
          <div className="mb-[30px]">
            <div className="text-[64px] font-bold text-white text-center mt-8 w-[90%] mx-auto">
              Welcome to 
            </div>
            <div className="text-[80px] font-bold text-white text-center mt-2 w-[90%] mx-auto">
              Star Wars Collectible Companion
            </div>
